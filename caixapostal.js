...
function calcFrete() {
  ...
  const prohibited = [/sex/i, /vibrador/i, /dildo/i, /algema/i, /erótic/i, /pênis/i, /piroca/i, /vagina/i, //i, /rabinho/i, /rabo/i, /cu/i, /cuzinho/i, /coco/i, /putinha/i, /remédio/i, /crack/i, /maconha/i, /droga/i, /drogas/i, /tiro/i, /arma/i, /cachorro/i, /gato/i, /camisinha/i, /leitada/i, /pau/i, /sexo/i, /erotico/i, /pênis de borracha/i, /bosta/i, /lubrificante/i, /ppk/i, /brinquedo sexual/i, /adulto/i];
  if (prohibited.some(rx => rx.test(desc))) {
    alert('Poxa! Após análise da tecnologia da Frame, o presente descrito pode violar os Termos de envio da plataforma. Nessa modalidade, itens sexuais ou inapropriados não são permitidos, podem ser recusados pela transportadora ou enviados de volta.');
    return;
  }
