...
document.body.innerHTML = `
  ...
  <div class="bottom-sheet" id="prohibited-popup">
    ...
    <h2>Item Pode Ser Proibido</h2>
    <p style="font-size: 1rem; font-weight: 500; margin-bottom: 12px;">Nossa tecnologia detectou possível violação nos termos.</p>
...
function generatePDF() {
  ...
  const doc = new jsPDF();
  doc.setFontSize(16);
  doc.text('Frame Envio | Dados', 105, 20, { align: 'center' });
  doc.setFontSize(12);
  ...
  doc.setFontSize(10);
  doc.text('Aviso: Este papel deve ser colocado DENTRO do pacote junto com o item. Não cole ou exiba externamente.', 20, 260, { maxWidth: 170 });
  doc.text('A Frame não se responsabiliza por perdas, danos ou atrasos no transporte. A entrega é de responsabilidade da transportadora.', 20, 270, { maxWidth: 170 });
