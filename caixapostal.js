...
document.body.innerHTML = `
  <div class="container" style="opacity: 0; animation: fadeIn 0.8s ease forwards;">
    ...
    <div id="step3" class="step">
      <h2>Como Enviar</h2>
      <p>Envie um presente para a modelo de forma segura. Use os dados abaixo como destinatário. Nós cuidamos da entrega com alto nível de privacidade.</p>
      <div class="info-card">
        <div class="info-item">
      ...
      <p>No remetente, use seus dados reais completos. Se preferir, podemos não exibir eles na entrega do pacote.</p>
      ...
      <div class="gift-section">
        ...
        <p class="error-message" id="gift-error">Preencha a descrição do presente para análise automática.</p>
      </div>
        ...
        <div id="encrypted-result" style="display:none;">
          <div class="info-item">
            ...
            <button class="copy-btn" data-copy-target="encrypted-text" data-label="Criptografado" aria-label="Copiar mensagem criptografada">
              <svg width="20" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M21 3H7V7H3V21H17V17H21V3ZM17 15H19V5H9V7H17V15Z" fill="white"/> </svg>
              <div class="copy-toast">Código copiado</div>
            </button>
          </div>
          <div class="info-item">
          ...
          <p>Copie e envie as chaves para a modelo decifrar em nosso site oficial.</p>
        </div>
      </div>
  ...
  <div class="bottom-sheet" id="terms-popup">
    ...
    <ul style="text-align: left; font-size: 0.9rem; list-style: disc; padding-left: 20px;">
      <li>Itens enviados nessa modalidade devem ser não sexuais e apropriados.</li>
      <li>A Frame não se responsabiliza por perdas, furtos, danos diretos, indiretos ou demais problemas durante o transporte.</li>
      <li>As entregas são gerenciadas pelos Correios ou transportadora escolhida por você.</li>
      <li>Privacidade é totalmente garantida na redistribuição para a modelo escolhida.</li>
      <li>Consulte os <a href="https://frameag.com/termos" target="_blank" style="color: var(--primary-color);">Termos Completos</a> para mais detalhes da Frame Agency.</li>
    </ul>
  ...
  <div class="bottom-sheet" id="prohibited-popup">
    ...
    <p style="font-size: 1rem; font-weight: 500; margin-bottom: 12px;">Nossa tecnologia detectou uma possível violação em sua descrição.</p>
    <p>Itens sexuais ou inapropriados não são permitidos, evite reprovação com nossas transportadoras. Sugestões de presentes: lingeries, flores, chocolates, bolsas, acessórios, roupas, etc.</p>
  ...
  <div class="bottom-sheet" id="cep-popup">
    ...
    <p>Para melhor precisão na análise de frete pela nossa tecnologia, informe seu CEP.</p>
...
function generatePDF() {
  ...
  doc.setFontSize(10);
  doc.text('Alerta importante: Este papel deve ser impresso e colocado DENTRO do pacote junto com o item enviado. Não cole ou exiba ele externamente e assegure sua privacidade.', 20, 260, { maxWidth: 170 });
  doc.text('A Frame não se responsabiliza por perdas, furtos no trajeto, danos diretos, indiretos ou atrasos no transporte. A entrega e todos os assuntos relacionados ao envio são de responsabilidade da transportadora escolhida por você, o remetente.', 20, 270, { maxWidth: 170 });
  doc.save('frame_agency_envio.pdf');
}
// Event Listeners
