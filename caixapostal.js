...
document.body.innerHTML = `
  <div class="container" style="opacity: 0; animation: fadeIn 0.8s ease forwards;">
    ...
    <div id="step3" class="step">
      <h2>Como Enviar</h2>
      <p>Envie presentes para uma modelo de forma simples e segura. Use os dados abaixo como destinatário. Nós cuidamos da entrega final com privacidade total.</p>
      <div class="info-card">
        <div class="info-item">
      ...
      <div class="gift-section">
        ...
        <textarea id="gift-desc" class="freight-input" placeholder="Descreva como será o seu presente para uma breve verificação de viabilidade de envio..."></textarea>
      </div>
