  ...
  <div class="container" style="opacity: 0; animation: fadeIn 0.8s ease forwards;">
    ...
    <div id="step3" class="step">
      ...
      <div class="gift-section">
        <h3>Descrição do Presente (opcional)</h3>
        <textarea id="gift-desc" class="freight-input" placeholder="Descreva o presente para verificação..."></textarea>
      </div>
      <div class="message-section">
        <h3>Mensagem Especial (opcional)</h3>
        <textarea id="special-message" class="freight-input" placeholder="Escreva uma mensagem para a modelo..."></textarea>
        <button class="btn" id="encrypt-message">Criptografar Mensagem</button>
        <div id="encrypted-result" style="display:none;">
          <p><strong>Mensagem Criptografada (IV:encrypted):</strong> <span id="encrypted-text"></span></p>
...
function calcFrete() {
  ...
  const prohibited = [/sex/i, /vibrador/i, /dildo/i, /erótic/i, /adulto/i];
  if (prohibited.some(rx => rx.test(desc))) {
    alert('O presente descrito pode violar os termos. Itens sexuais ou inapropriados não são permitidos.');
    return;
  }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('go-correios').addEventListener('click', () => {
    window.open('https://www.correios.com.br/enviar/calculo-de-precos', '_blank');
